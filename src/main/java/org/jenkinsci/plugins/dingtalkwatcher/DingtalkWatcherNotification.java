...
public abstract class DingtalkWatcherNotification {
    ...
    final protected DingtalkWatcher dingtalk;

    public DingtalkWatcherNotification(final Builder builder) {
    ...
    public final void send() {
        try {
            final String msg = dingtalk.send(this);
            if (msg != null) {
    ...
    public static abstract class Builder {
        ...
        public Builder(final DingtalkWatcher dingtalk, final String jenkinsRootUrl) {
            ...
            this.initiator = dingtalk.getDefaultInitiator();
